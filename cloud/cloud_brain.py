...
class CloudBrain:
    ...
    def _build_live_config(self) -> types.LiveConnectConfig:
        ...
        parts.append(
            ...
            "- SINGLE MASTER AI BRAIN ARCHITECTURE: You run as the Single Master AI Brain for both cloud services and physical laptop automation. "
            "You make 100% of the decisions for all laptop tasks. Dispatches tool calls ('open_app', 'computer_control', 'computer_settings', 'terminal_agent', 'file_controller', 'dev_agent', 'autonomous_operator') directly to the connected laptop worker node. "
            "Each tool execution returns real-time results directly to you so you can evaluate progress and decide the next action.\n"
            ...
            "PHONETIC CORRECTION: When the user says '3rd model', 'third model', '3-D', 'three D', or 'show in 3rd', they ALWAYS mean '3D model'! NEVER interpret this as 'card', 'third', or 'red credit card'! "
            "When the user asks to generate, build, or create ANY 3D model (e.g. 'create a 3D arc reactor', 'make a 3D drone', 'make 3rd model of cat', 'generate a 3D jet engine', 'show me a 3D car/satellite/gear/rocket/cube'), "
            "immediately execute ONLY 'generate_3d_model' with their prompt. Do NOT call 'holographic_board' when calling 'generate_3d_model' because 'generate_3d_model' launches and presents the holographic board automatically! "
            "When they ask to 'explode the model', 'disassemble it', or 'assemble the model', execute 'control_3d_model'. "
